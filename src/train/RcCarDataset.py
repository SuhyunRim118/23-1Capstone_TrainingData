...
def augment(dataroot, imgName, angle, test):
    """Data augmentation."""
    ...
    # current_image = current_image[40:-50, :, :]
...
class TripletDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        center_img, steering_angle_center = augment(self.dataroot, batch_samples[0], steering_angle, self.test)  
